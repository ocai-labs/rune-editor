...
- 0487a04: Keep the media source popover in place when its tab changes.

  "Embed link" is taller than "Upload" — it adds a URL field above the same
  button — so switching to it grew the popover. Near the bottom of the viewport
  that growth re-triggered the collision check and flipped the whole popover above
  the block, on what the user experienced as a tab click.

  Flipping is right when the popover genuinely does not fit. Holding its size
  constant is what confines that decision to the moment it opens, so a tab click
  now only swaps the input.
...
- Updated dependencies [f852605]
- Updated dependencies [85319bb]
- Updated dependencies [ae4ff99]
- Updated dependencies [72b621d]
- Updated dependencies [72b621d]
- Updated dependencies [beb825d]
- Updated dependencies [87f1007]
- Updated dependencies [0dde585]
- Updated dependencies [72b621d]
- Updated dependencies [0e65f55]
- Updated dependencies [72b621d]
- Updated dependencies [f1208e1]
- Updated dependencies [0e65f55]
- Updated dependencies [1d5b4af]
  - @ocai/rune-core@0.23.1-alpha.1
...
- Updated dependencies [4196c8a]
- Updated dependencies
  - @ocai/rune-core@0.23.0

## 0.22.3

### Patch Changes

- Updated dependencies [c4ebda1]
  - @ocai/rune-core@0.22.3
...
- Updated dependencies [7054f11]
  - @ocai/rune-core@0.22.0
...
- Updated dependencies [5cb5b98]
  - @ocai/rune-core@0.21.2
...
- 43e412f: Add a stable `.rune-chrome-surface` styling hook to Rune's Tailwind floating
  panels, including the media toolbar surfaces. Non-Tailwind panels continue to
  use `.rune-chrome`, allowing host themes to target both paths without relying
  on the interaction-only `data-rune-editor-chrome` attribute.
...
- Updated dependencies [3c07c97]
  - @ocai/rune-core@0.19.2
